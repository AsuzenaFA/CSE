...
class Letter(WeirdStuff):
    def __init__(self):
        super(Letter, self).__init__("Letter to the Three", "This is the letter the bartender gave you.")


class Medication(WeirdStuff):
    def __init__(self):
        super(Medication, self).__init__("Antidepressants", "This is Elijah's meds")
...
Water_Fountain = Room("Broken Water Fountain", 'Backyard', 'SF', 'EF', 'WF',
...
BB = Room("Broken Bridge", None, None, None, 'Tar_River',
...
Merchant = Room("Clerk's Items and More", 'Gates', None, None, None,
                ...
                "\nsword with weird carvings and spot medication"
                "\n== Token =="
                "\nHey new comer welcome to my shop, oh you have that mark on your neck,"
                "\nwell i guess you can take what ever you like... the thing here aren't that useful.", None, Merchant)
...
PlayerActions = ['talk', 'take', 'drop', 'help']
